...
// @updateURL    https://cdn.jsdelivr.net/gh/MCBBS-Loader/MCBBS-Loader-Core@stable/dist/stable.bundle.prod.user.js
// @grant        unsafeWindow
// @grant        GM_addStyle
...
// CONCATENATED MODULE: ./src/api/NTAPI.ts
;
...
var ML_VERSION = 1;
var NTAPI_all;
function setMods(list) {
    NTAPI_all = list;
}
function forkAPI(id) {
    return new MCBBSAPI(id);
}
(0,usfunc/* setWindowProperty */.oE)("MIDT", {});
var MCBBSAPI = (function () {
    function MCBBSAPI(id) {
        var _this = this;
        this.getAPIVersion = getAPIVersion;
        this.download = usfunc/* GMDownload */.JK;
        this.export_ = function (obj) {
            moduleExport(_this.id, obj);
        };
        ...
        if (hasPermission(id, "loader:core")) {
            this.eval = codeload/* coreModEval */.AS;
            this.GM = (0,libs_native/* getGM */.rj)();
        }
        else {
            this.eval = undefined;
            this.GM = undefined;
    ...
    MCBBSAPI.prototype.storeData = function (k, v) {
        storeData(this.id + "-" + k, v);
    };
    MCBBSAPI.prototype.createConfig = function (stgid, name, type, desc) {
        var map = new Map();
        ...
        map.set("id", this.id);
        map.set("type", type);
        configpage/* default.createConfigItem */.Z.createConfigItem(map);
    };
    MCBBSAPI.prototype.getConfigVal = function (stgid, dval) {
        return configpage/* default.getConfigVal */.Z.getConfigVal(this.id, stgid, dval || undefined);
    };
    MCBBSAPI.prototype.getData = function (k, dv) {
...
function moduleExport(idIn, obj) {
    (0,usfunc/* setWindowProperty */.oE)("module-export-" + idIn, obj);
    notifyExport(idIn);
}
function moduleImport(id, callback) {
    if ((0,usfunc/* getWindowProperty */.vo)("module-export-" + id)) {
        callback((0,usfunc/* getWindowProperty */.vo)("module-export-" + id));
    }
    else {
        var origin = (0,usfunc/* getWindowProperty */.vo)("MIDT")[id];
        if (origin) {
            var nc = function (obj) {
                origin(obj);
                callback(obj);
            };
            (0,usfunc/* getWindowProperty */.vo)("MIDT")[id] = nc;
        }
        else {
            (0,usfunc/* getWindowProperty */.vo)("MIDT")[id] = callback;
        }
    }
    return !!NTAPI_all[id];
}
function notifyExport(id) {
    for (var x in (0,usfunc/* getWindowProperty */.vo)("MIDT")) {
        if (x == id) {
            (0,usfunc/* getWindowProperty */.vo)("MIDT")[x]((0,usfunc/* getWindowProperty */.vo)("module-export-" + id));
            var m = (0,usfunc/* getWindowProperty */.vo)("MIDT");
            delete m[x];
            (0,usfunc/* setWindowProperty */.oE)("MIDT", m);
        }
    }
}
function storeData(tag, data) {
    (0,usfunc/* GMSetValue */.s4)("data-" + tag, data);
}
function getData(tag, defaultVal) {
    return (0,usfunc/* GMGetValue */.o9)("data-" + tag, defaultVal);
}
...
/* harmony export */   "WM": () => /* binding */ addModule,
/* harmony export */   "uk": () => /* binding */ mountCode,
/* harmony export */   "wZ": () => /* binding */ deleteModule,
/* harmony export */   "qA": () => /* binding */ installFromUrl,
/* harmony export */   "jw": () => /* binding */ parseMeta,
/* harmony export */   "eT": () => /* binding */ isDirty,
/* harmony export */   "no": () => /* binding */ markDirty,
/* harmony export */   "AS": () => /* binding */ coreModEval,
/* harmony export */   "t3": () => /* binding */ resortDependency,
/* harmony export */   "mP": () => /* binding */ setDependencyError,
/* harmony export */   "ul": () => /* binding */ getDependencyError,
/* harmony export */   "m4": () => /* binding */ isDependencySolved
/* harmony export */ });
/* unused harmony export unmountCode */
...
var STRING_API_VERSION = String((0,_api_NTAPI__WEBPACK_IMPORTED_MODULE_1__/* .getAPIVersion */ .Y9)());
var dirty = false, dependencyError = "";
function getDependencyError() {
    return dependencyError;
}
function setDependencyError(error) {
...
function addModule(code) {
    ...
    if (!isModuleRegex.test(ccode)) {
        ...
        var depend = dataMap.get("depend") || "", before, after, apiVersion, id = dataMap.get("id");
        if (id === undefined) {
            return "未提供 id 数据值";
        }
        if (!verifyId(id)) {
...
function mountCode(id, code) {
    jquery__WEBPACK_IMPORTED_MODULE_0___default()(function () {
        jquery__WEBPACK_IMPORTED_MODULE_0___default()("body").append("<script id='code-" + id + "' onload='this.parentNode.removeChild(this);'>(function(){var MCBBS = Object.freeze(window.forkAPI_" + (0,_encrypt__WEBPACK_IMPORTED_MODULE_2__/* .getAPIToken */ .M)() + "(\"" + id + "\"));\n" + code + "\nvar _sele = document.getElementById('code-" + id + "');_sele.parentNode.removeChild(_sele);})()</script>");
    });
}
function unmountCode(id) {
    jquery__WEBPACK_IMPORTED_MODULE_0___default()(function () {
        jquery__WEBPACK_IMPORTED_MODULE_0___default()("#code-" + id).remove();
    });
}
...
function installFromUrl(url, onsuccess, onerror) {
    try {
        jquery__WEBPACK_IMPORTED_MODULE_0___default().get(url, function (dataIn) {
            try {
...
/* harmony export */ });
/* harmony import */ var _usfunc__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(204);
/* harmony import */ var jquery__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(755);
/* harmony import */ var jquery__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(jquery__WEBPACK_IMPORTED_MODULE_0__);
...
function dumpConfigPage() {
    jquery__WEBPACK_IMPORTED_MODULE_0___default()("div[class='bm bw0']").html("<span style='font-size:1.5rem'>设置中心</span>&nbsp;&nbsp;<button id='saveconfig' type='button' class='pn pnc'>" +
        "<span>保存</span></button><div id='config_div'></div>");
    jquery__WEBPACK_IMPORTED_MODULE_0___default()("#saveconfig").on("click", autoSave);
    renderAll();
}
function autoSave() {
    var e_1, _a;
...
function createConfigItem(details) {
    ...
    var CDT = (0,_usfunc__WEBPACK_IMPORTED_MODULE_2__/* .getWindowProperty */ .vo)("CDT");
    CDT.push({
        id: id,
        type: type,
        storageId: storageId,
    ...
    (0,_usfunc__WEBPACK_IMPORTED_MODULE_2__/* .setWindowProperty */ .oE)("CDT", CDT);
}
function createMenu() {
    (0,_usfunc__WEBPACK_IMPORTED_MODULE_2__/* .setWindowProperty */ .oE)("getConfig", function (id, sid) {
        return getConfigVal(id, sid, undefined);
    });
    jquery__WEBPACK_IMPORTED_MODULE_0___default()(function () {
        jquery__WEBPACK_IMPORTED_MODULE_0___default()("div.appl > div.tbn > ul").prepend("<li><a id='manage_config' style='cursor:pointer;'>模块选项中心</a></li>");
        jquery__WEBPACK_IMPORTED_MODULE_0___default()("#manage_config").on("click", dumpConfigPage);
    });
}
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({ createMenu: createMenu, dumpConfigPage: dumpConfigPage, createConfigItem: createConfigItem, getConfigVal: getConfigVal });
...
"use strict";
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "M": () => /* binding */ getAPIToken
/* harmony export */ });
...
function popinfo(icon, msg, doSpark, style, move, time, size) {
    ...
    setTimeout(function () {
        ...
        if (doSpark) {
            spark(jquery__WEBPACK_IMPORTED_MODULE_0___default()("#_popicon"), time);
        }
        jquery__WEBPACK_IMPORTED_MODULE_0___default()("#_popbg").animate({ bottom: "0" }, move, "swing");
    }, 110);
}
function closepop(move, cb) {
    if (move === void 0) { move = 100; }
    if (cb === void 0) { cb = function () { }; }
    jquery__WEBPACK_IMPORTED_MODULE_0___default()("#_popbg").animate({ bottom: "-5%" }, move, "swing", function () {
        jquery__WEBPACK_IMPORTED_MODULE_0___default()("#_popbg").remove();
        cb();
    });
}
...
"use strict";
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "Q": () => /* binding */ loadNTEVT
/* harmony export */ });
function loadNTEVT() {
  (async () => {
...
"use strict";
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "Hn": () => /* binding */ setProperty,
/* harmony export */   "$s": () => /* binding */ getProperty,
/* harmony export */   "LP": () => /* binding */ getUnsafeWindow,
/* harmony export */   "VI": () => /* binding */ setLockedProperty,
/* harmony export */   "rj": () => /* binding */ getGM
/* harmony export */ });
...
"use strict";
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "LB": () => /* binding */ GMDeleteValue,
/* harmony export */   "s4": () => /* binding */ GMSetValue,
/* harmony export */   "o9": () => /* binding */ GMGetValue,
/* harmony export */   "n$": () => /* binding */ GMLog,
/* harmony export */   "J9": () => /* binding */ GMNotification,
/* harmony export */   "JK": () => /* binding */ GMDownload,
/* harmony export */   "oE": () => /* binding */ setWindowProperty,
/* harmony export */   "vo": () => /* binding */ getWindowProperty
/* harmony export */ });
/* unused harmony exports GMAddStyle, GMListValues, GMGetResourceText, GMGetResourceURL, GMSetClipBoard */
...
function setup(callback) {
    jquery_default().get("https://cdn.jsdelivr.net/gh/MCBBS-Loader/MCBBS-Loader-Data@main/batteries.json", function (data) {
        data === null || data === void 0 ? void 0 : data.forEach(codeload/* installFromUrl */.qA);
        callback();
    });
}
...
(function () {
    (0,NTEVT/* loadNTEVT */.Q)();
    jquery_default()(function () {
        jquery_default()("head").append("<link type='text/css' rel='stylesheet' href='https://cdn.staticfile.org/font-awesome/5.15.1/css/all.min.css'></link>");
        jquery_default()("head").append("<link type='text/css' rel='stylesheet' href='https://cdn.staticfile.org/font-awesome/5.15.1/css/v4-shims.min.css'></link>");
    });
    if ((0,usfunc/* GMGetValue */.o9)("loader.ibatteries", true)) {
        setup(function () { });
        (0,usfunc/* GMSetValue */.s4)("loader.ibatteries", false);
    }
    (0,usfunc/* GMLog */.n$)("[MCBBS Loader] \u52A0\u8F7D\u5668\u548C API \u7248\u672C\uFF1A" + (0,NTAPI/* getAPIVersion */.Y9)());
    ...
    (0,libs_native/* setLockedProperty */.VI)((0,libs_native/* getUnsafeWindow */.LP)(), "reset_" + RESET_TOKEN, function () {
        ...
        if (sureToReset) {
            ...
            (0,usfunc/* GMLog */.n$)("[MCBBS Loader] 重置完成，下次别安装不可靠模块了~");
        }
        else {
            sureToReset = true;
            (0,usfunc/* GMLog */.n$)("[MCBBS Loader] 确定要重置吗？这将禁用所有模块！\n如果确定重置，请再调用一次该函数。");
        }
    });
    (0,usfunc/* GMLog */.n$)("[MCBBS Loader] 重置令牌：reset_" + RESET_TOKEN);
    ...
    jquery_default()(function () {
        ...
        if (sortedList instanceof Array) {
            ...
            (0,usfunc/* GMLog */.n$)("[MCBBS Loader] " + sortedList);
        ...
        if ((0,usfunc/* GMGetValue */.o9)("temp.loadcfg", false)) {
            (0,usfunc/* GMSetValue */.s4)("temp.loadcfg", false);
            configpage/* default.dumpConfigPage */.Z.dumpConfigPage();
        }
    });
})();
