...
function popinfo(
  ...
  setTimeout(() => {
    var data = `<div id='_popbg' style='user-select:none;cursor:default;width:100%;height:50px;background-color:#02020275;position:fixed;bottom:-50px;text-align:center;color:#ffffff;'><i style='font-size:${size};vertical-align:middle;${style}' id='_popicon' class='fa fa-${icon}'></i><span style='padding-top:2px;display:inline-block;vertical-align:middle;line-height:50px;'>&nbsp;&nbsp;&nbsp;${msg}</span></div>`;
    $("body").append(data);
    if (doSpark) {
      spark($("#_popicon"), time);
    }
