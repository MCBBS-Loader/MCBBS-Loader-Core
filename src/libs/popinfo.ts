...
function popinfo(
  ...
  var ctime = time || 500;
  var data = `<div id='_popbg' style='user-select:none;cursor:default;width:100%;height:-50px;background-color:#02020275;position:fixed;bottom:-50px;text-align:center;color:#ffffff;'><i style='font-size:${
    size || "28px"
